    ...
    <div className={styles.wrapper}>
      <div className={styles.flex}>
        <div className={styles.left}>
          <span className={styles.required}>*</span>部门名称 ：
        </div>
        <div className={styles.right}>
          <Input
            onChange={(e) => {
              // const newCurrentItem = { ...currentItem, department: e?.target?.value };
              const newCurrentItem = { ...currentItem, title: e.target.value, department: e.target.value };
      ...
      <div className={styles.flex}>
        ...
        <div className={styles.right}>
          <Input
            ...
            placeholder="你在经历中的主要工作是什么呢？以|进行分割"
            allowClear={isEdit}
            disabled={!isEdit}
          />
